...
class NetworkExceptions with _$NetworkExceptions {
  ...
  static NetworkExceptions handleResponse(String? data, int statusCode) {
    var errorData;
    if (data != null) {
      errorData = jsonDecode(data);
    }
    print('Error data: $errorData statusCode: $statusCode');
    switch (statusCode) {
      case 400:
      case 401:
      case 403:
        ...
        break;
      case 404:
        return NetworkExceptions.notFound(errorData['title']);
        break;
      case 409:
